...
FirebaseService service = FirebaseService();  TextEditingController adminEml = TextEditingController();
      ...
      body: Center(
        child: SingleChildScrollView(
          child: Column(
              ...
              Container(
                ...
                child: Neumorphic(
                      style: NeumorphicStyle(
                          ...
                          boxShape:
                              NeumorphicBoxShape.roundRect(BorderRadius.circular(35.0)),
                          intensity: 10,
            ...
            backgroundColor: MaterialStateProperty.all<Color>(Color(0xff1A237A)),
